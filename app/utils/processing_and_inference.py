...
from utils.model_def import model_definition
import itertools
import re

MODEL_FILENAME = 'data/best_license_plate_model.pt'

def process_uploaded_image(image_data: io.BytesIO):

    detected_license_plate, confidence = detect_lp(image_data)
    # detected_license_plate = Image.open()
    ...
    return detected_license_plate, confidence, inverted_image, uploaded_img
